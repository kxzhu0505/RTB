  ...
  { 
    ...
    forall(p,L){
      ...
      if (e!=NULL && Delau.S.is_diagram_edge(e)  && !Delau.S.is_hull_edge(e)){
       ...
       e2 = Delau.S.d_face_cycle_succ(e);
...
int main()
{
  ...
  string msg1("Activate other input scene (RationalPoints-2) for demonstration of");
  string msg2("nearest neighbor algorithm. Use Scenes-activate menu button for");
  string msg3("activating a scene.");
